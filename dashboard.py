...
st.set_page_config (
    page_title="Dashboard Rental Sepeda",
    page_icon="🖥️"
)
...
fig, ax = plt.subplots(figsize=(16,8))
ax.scatter(x=bytemp_df.index, y=bytemp_df["casual"], label="Casual", color='#00695C')
ax.scatter(x=bytemp_df.index, y=bytemp_df["registered"], label="Registered",color='#4DB6AC')
...
fig, ax = plt.subplots(figsize=(16,8))
ax.scatter(x=byhum_df.index, y=byhum_df["casual"], label="Casual",color='#00695C')
ax.scatter(x=byhum_df.index, y=byhum_df["registered"], label="Registered",color='#4DB6AC')
...
fig, ax = plt.subplots(figsize=(16,8))
ax.scatter(x=bywindspeed_df.index, y=bywindspeed_df["casual"], label="Casual", color='#00695C')
ax.scatter(x=bywindspeed_df.index, y=bywindspeed_df["registered"], label="Registered", color='#4DB6AC')
